...
mon_parser_general.add_argument("--format", nargs=2, help="Donner le format de sortie de la playlist "+str(liste_des_format_de_sortie)+" suivi du nom du fichier de sauvegarde de la playlist (chemin absolu ou relatif, ou '-' pour stdout)")
...
non_regexp_group.add_argument("-t", "--titre", nargs=2, help="Spécifier le titre à intégrer à la playlist suivi de la quantité escompté en %%")
...
regexp_group.add_argument("-S", "--RE-sous-genre", nargs=2, help="Spécifier le sous-genre à intégrer à la playlist suivi de la quantité escompté en %%")
...
regexp_group.add_argument("-T", "--RE-titre", nargs=2, help="Spécifier le titre à intégrer à la playlist suivi de la quantité escompté en %%")
